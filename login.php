                    ...
                    <div class="modal-body">
                        <form class="form-signin" action="./signin.php" method="post">
                            <div class="form-label-group">
                                ...
                                <input name="email" type="email" id="inputEmailIn" class="form-control" placeholder="Email address" required autofocus />
                            </div>

                            <div class="form-label-group">
                                <label for="inputPasswordIn">Password</label>
                                <input name="password" type="password" id="inputPasswordIn" class="form-control" placeholder="Password" required />
                            </div>
